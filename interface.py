...
class Interface:
    ...
    def iniciate_interface(self):
        ...
        self.music_theme = pygame.mixer.Sound("Audio/theme.wav")

        self.background = pygame.image.load("sprites/Tavern800x600.png")
        self.bob = pygame.image.load("sprites/busto_test.png")
        self.bob_talking = pygame.image.load("sprites/busto_talking_test.png")

        pygame.mouse.set_visible(False)

        mouse = Mouse("sprites\cursor.png")
        self.mouse_group = pygame.sprite.Group()
        self.mouse_group.add(mouse)

        mouse_click = Mouse("sprites\cursor_clicked.png")
